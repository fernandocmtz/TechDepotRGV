      ...
      <section className="relative h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="container relative z-20 mx-auto px-4 md:px-6">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 animate-fade-up" style={{ animationDelay: "100ms" }}>
              Build Your Perfect System with Premium Components
            </h1>
            <p className="text-lg text-white/80 mb-8 leading-relaxed animate-fade-up" style={{ animationDelay: "200ms" }}>
              Discover our meticulously curated selection of high-quality tech components,
              designed for professionals, enthusiasts, and gamers who demand nothing but the best.
            </p>
      ...
      <section className="py-24 bg-tech-light">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-12">
            <div>
              <span className="text-sm font-medium text-tech-blue">Discover</span>
              <h2 className="text-3xl font-bold mt-1">Featured Products</h2>
            </div>
            <Button variant="link" asChild className="text-tech-blue no-underline">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-sm font-medium text-tech-blue">Categories</span>
            <h2 className="text-3xl font-bold mt-1 mb-4">Find What You Need</h2>
            <p className="text-muted-foreground">
              Browse our wide selection of components, organized by category for easy navigation.
            </p>
          </div>
      ...
      <section className="py-24 bg-tech-blue/10">
        <div className="container mx-auto px-4 md:px-6">
          <div className="glass bg-white/60 rounded-2xl p-8 md:p-12 shadow-sm border border-white/40 max-w-4xl mx-auto">
            <div className="text-center">
              <h2 className="text-3xl font-bold mb-4">Ready to Build Your Dream System?</h2>
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join thousands of satisfied customers who trust us for their tech component needs.
